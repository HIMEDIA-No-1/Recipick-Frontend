                ...
                <div className="space-y-4 mb-8">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 px-6 py-3 border border-[#D1D1D1] text-[#4B4B4B] dark:text-[#E0E0E0] hover:bg-[#E0EBF7] dark:hover:bg-[#404040] font-medium rounded-lg transition-colors"
                        >
